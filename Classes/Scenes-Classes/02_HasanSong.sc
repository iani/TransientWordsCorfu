HasanSong {
	*plain {
		...
		1.0 +>.vol \hasansong;
		SF.playbuf24 ++> \hasansong;
	}

	*plain2 {
		"--- Starting Hasan Song: PLAIN".postln;
		// "hasansong(dalwk.amp)".arlink;
		'song4_hasan'.bufnum +>.buf \hasansong2;
		0.5 +>.vol \hasansong2;
		SF.playbuf24 ++> \hasansong2;
	}

	*plain3 {
		"--- Starting Hasan Song: PLAIN".postln;
		// "hasansong(dalwk.amp)".arlink;
		'song4_hasan'.bufnum +>.buf \hasansong3;
		0.3 +>.vol \hasansong3;
		SF.playbuf24 ++> \hasansong3;
	}

	*plain4 {
		"--- Starting Hasan Song: PLAIN".postln;
		// "hasansong(dalwk.amp)".arlink;
		'song4_hasan'.bufnum +>.buf \hasansong4;
		0.1 +>.vol \hasansong4;
		SF.playbuf24 ++> \hasansong4;
	}
	...
	*pv2 {
		"--- Starting Hasan Song: PV".postln;
		"(hasansong2.pv2)".arlink;

		SF.magbelowpan ++> \pv2;
		
		'song4_hasan'.bufnum +>.buf \hasansong2;
		0.2 +>.vol \hasansong2;
		SF.playbuf ++> \hasansong2;
	}
