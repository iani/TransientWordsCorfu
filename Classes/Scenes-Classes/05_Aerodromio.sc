...
Aerodromio {
	...
	*lpfnoise {
		{ LPF.ar(Inp.ar, LFNoise0.kr([2, 3]).range(1000, 2000)) * 2 } ++> \veryfastlpf;
	}

	*hpfnoise {
		{ HPF.ar(Inp.ar, LFNoise0.kr([1, 2]).range(1000, 2000)) * 2 } ++> \veryfastlpf;
	}

	*resonznoise0 {
		{ Resonz.ar(Inp.ar, LFNoise0.kr([3, 2]).range(1800, 2000)) * 2 } ++> \veryfastlpf;	
	}

	*resonznoise1 {
		{ Resonz.ar(Inp.ar, LFNoise1.kr([5, 5]).range(200, 10000)) * 2 } ++> \veryfastlpf;	
	}
